...
plot(mp_classif_rf_oxidative.stress, mp_classif_glm_oxidative.stress)
```
```{r}
plot(mp_classif_rf_oxidative.stress, mp_classif_glm_oxidative.stress, geom = "boxplot")
```
...
# predict NOEC
ox.3$particles.mL.ox.stress <- predict(classif_rf_oxidative.stress, ox.3, type = "raw")
...
# predict NOEC
food.3$particles.mL.food.dilution <- predict(classif_rf_food.dilution, food.3, type = "raw")
