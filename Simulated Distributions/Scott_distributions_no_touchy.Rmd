...
aoc_z <- readRDS(file = "Tox Data/aoc_z.Rda") %>% rowid_to_column()
## Data filtering
```
...
composition_realistic_shapes_food <- df_oxidative.stress %>% 
  ...
  distinct(species_f, max.size.ingest.mm, life.stage, bio.org, lvl1_f, lvl2_f,
           ...
           EVA_frac,
           #LTX_frac, 
           PA_frac, PC_frac, PE_frac, PET_frac, PLA_frac, PMMA_frac, PP_frac, PS_frac, PUR_frac, PVC_frac, 
