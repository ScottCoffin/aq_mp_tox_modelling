...
#define mu_x_mono for alignment to ERM
  ...
  mutate(x_UL_v_ingest = volumefnx_poly(length = x2M_ingest,
                                        width = x2M_ingest)) %>% 
  # calculate mu.v.poly
...
ox.1.emp <- aoc_final %>%
  filter(#environment == "Marine",
         ...
         between(size.length.um.used.for.conversions, 1, 83)) %>% 
...
kable(hcxx, caption = "Food Dilution Thresholds")

write.csv(hcxx, file = "Simulated Distributions/BigDataManuscript/foodDilutionhcxx.csv")
```
