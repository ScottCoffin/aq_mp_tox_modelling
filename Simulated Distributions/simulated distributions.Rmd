...
synthetic_data_builder <- function(n){
...
Data <- synthetic_data_builder(n = 10000)
...
summary_df <- bind_rows(
                        summarise_add_volume(data = Data, volume_l = 1),
                        summarise_add_volume(data = Data, volume_l = 10),
                        summarise_add_volume(data = Data, volume_l = 100),
                        summarise_add_volume(data = Data, volume_l = 1000)
                        )
ggplot() +
...
prob_summ <- bind_rows(
  synthetic_data_builder_with_prediction(n = 5), 
  synthetic_data_builder_with_prediction(n = 10),
  synthetic_data_builder_with_prediction(n = 20),
  synthetic_data_builder_with_prediction(n = 40),
  synthetic_data_builder_with_prediction(n = 80),
  synthetic_data_builder_with_prediction(n = 160),
  synthetic_data_builder_with_prediction(n = 320),
  synthetic_data_builder_with_prediction(n = 480),
  synthetic_data_builder_with_prediction(n = 640),
  synthetic_data_builder_with_prediction(n = 1000),
  synthetic_data_builder_with_prediction(n = 1280)
  ) %>%
...
#   facet_wrap(~particles.total)
  ...
  # scale_y_continuous(labels = scales::percent)+
  # labs(title = "Cumulative Toxicity Probability",
  #      subtitle = "n = 1000 particles/mL; Crustacea acute Mortality",
  #      caption = "Predicted Toxicity from Random Forest")
```
