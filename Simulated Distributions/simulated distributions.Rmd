...
##++++++++++++++++++++++++++++++++++++++++
Data <- synthetic_data_builder(n = 10000, volume_l = 1, addedfactors = possible_variables[488,])
...
for(loop in volumes){
    n = n + 1
    list[[n]] <- synthetic_data_builder(n = 10000, 
                                        volume_l = loop, 
...
## Quick check results
##++++++++++++++++++++++++++++++++++++++++
p1 <- ggplot(synthetic_data_builder(n = 10000, 
                                    volume_l = 1000, 
                                    addedfactors = possible_variables[488,]
                                    ), 
...
p2 <- ggplot(synthetic_data_builder(n = 10000, 
                                    volume_l = 1000, 
                                    addedfactors = possible_variables[488,]
                                    ), 
...
p3 <- ggplot(synthetic_data_builder(n = 10000, 
                                    volume_l = 1000, 
                                    addedfactors = possible_variables[488,]
                                    ), 
...
p4 <- ggplot(synthetic_data_builder(n = 10000, 
                                    volume_l = 1000, 
                                    addedfactors = possible_variables[488,]
                                    ),
...
p7 <- ggplot(synthetic_data_builder(n = 10000, 
                                    volume_l = 1000, 
                                    addedfactors = possible_variables[488,]
                                    ),
...
p8 <- synthetic_data_builder(n = 10000, 
                                    volume_l = 1000, 
                                    addedfactors = possible_variables[488,]
                                    ) %>% 
        group_by(size.category) %>% 
...
p9 <- ggplot(synthetic_data_builder(n = 10000, 
                                    volume_l = 1000, 
                                    addedfactors = possible_variables[488,]
                                    ), 
