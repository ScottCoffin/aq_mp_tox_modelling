...
synthetic_data_builder <- function(n){
  #Preset parameters for pdfs
      ...
      Data %>%  
        ...
        mutate(particles.total = factor(n))
}
...
summarise_add_volume <- function(data, volume_l){
  data %>% 
    ...
    mutate(volume.L = factor(volume_l))
}
...
```{r, include=FALSE}
Data_5p <- synthetic_data_builder(n = 5)
Data_10p <- synthetic_data_builder(n = 10)
Data_20p <- synthetic_data_builder(n = 20)
Data_40p <- synthetic_data_builder(n = 40)
Data_80p <- synthetic_data_builder(n = 80)
Data_160p <- synthetic_data_builder(n = 160)
Data_320p <- synthetic_data_builder(n = 320)
Data_480p <- synthetic_data_builder(n = 480)
Data_640p <- synthetic_data_builder(n = 640)
Data_1000p <- synthetic_data_builder(n = 1000)
Data_1280p <- synthetic_data_builder(n = 1280)
