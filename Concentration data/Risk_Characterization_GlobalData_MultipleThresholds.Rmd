...
#Food dilution
Threshold1_food = 0.2 / AF
Threshold2_food = 2.0 / AF
Threshold3_food = 5.4 / AF
Threshold4_food = 33.9 / AF

#Oxidative stress
Threshold1_oxidative.stress = 56.6 / AF
Threshold2_oxidative.stress = 299.4 / AF
Threshold3_oxidative.stress = 1385 / AF
Threshold4_oxidative.stress = 5470 / AF
```
...
#join data
globalData <- rbind(adam_sub, sfBay_new, covernton_new) %>% 
...
globalData %>% 
 ...
 geom_boxplot(notch = TRUE) +
   scale_fill_manual(name = "Location", 
                     labels = c("Rivers and Lakes",
                                "Oceans",
                                  "San Francisco Bay"
                                                  ),
                    values = cal_palette("superbloom3")) + 
                    #values = c("#00798c", "#d1495b")) +
  scale_x_continuous(name = "Particles/L (1-5,000 um)",
