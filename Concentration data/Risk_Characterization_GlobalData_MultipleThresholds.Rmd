...
#particles/L
Threshold1 = 1700000 #1,700
Threshold2 = 2310000 #383000
Threshold3 = 2280000 #391000
Threshold4 = 4990000 #1e6
...
dfADAM_exceedance %>% 
  ...
  geom_text(aes(x = Threshold1- 0.5*Threshold1, y = 0.055), label = paste(Threshold1,"particles/L"),  color = "goldenrod2") +
  ...
  geom_vline(xintercept = Threshold4, linetype = 'dashed', color = 	'wheat', size = 1.3) +
  geom_text(label = "Threshold 1", color = 'goldenrod2', x = Threshold1, y = 0.15, size = 6)+
  geom_text(label = "Threshold 2", color = 'tomato1', x = Threshold2, y = 0.22, size = 6)+
  geom_text(label = "Threshold 3", color = 'mediumvioletred', x = Threshold3, y = 0.35, size = 6)+
  geom_text(label = "Threshold 4", color = 'wheat', x = Threshold4, y = 0.45, size = 6)+
  scale_x_log10() +
  ...
  scale_fill_manual(values = c("below Threshold 1"= "cyan3", 
                               ...
                               "above Threshold 3" = "mediumvioletred", 
                               "above Threshold 4" = "wheat")) +
