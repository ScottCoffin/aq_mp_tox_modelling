...
#particles/L
Threshold1 = 1700 * 1000 #1,700
Threshold2 = 2310 * 1000 #383000
Threshold3 = 2280 * 1000 #391000
Threshold4 = 4990 * 1000 #1e6
...
dfADAM_exceedance %>% 
 ...
 # geom_text(label = "Threshold 1", color = 'goldenrod2', x = Threshold1, y = 0.055, size = 6)+
 #  geom_text(label = "Threshold 2", color = 'tomato1', x = Threshold2, y = 0.055, size = 6)+
 #  geom_text(label = "Threshold 3", color = 'mediumvioletred', x = Threshold3, y = 0.055, size = 6)+
 #  geom_text(label = "Threshold 4", color = 'gray33', x = Threshold4, y = 0.055, size = 6)+
