...
large.base.t2 <- SSD_function_t2(filtered.data = filtered.data.large.base_t1.2, hcx = 5)
large.base.t3 <- SSD_function_t3_4(filtered.data = filtered.data.large.base_t3.4, hcx = 5)
large.base.t4 <- SSD_function_t3_4(filtered.data = filtered.data.large.base_t3.4, hcx = 10)
...
small.base.t2 <- SSD_function_t2(filtered.data = filtered.data.small.base_t1.2, hcx = 5)
small.base.t3 <- SSD_function_t3_4(filtered.data = filtered.data.small.base_t3.4, hcx = 5)
small.base.t4 <- SSD_function_t3_4(filtered.data = filtered.data.small.base_t3.4, hcx = 10)
```
## Summary Table
...
base_thresholds <- tibble(
  ...
  "Food Dilution (base Endpoints)" = c(large.base.t1, large.base.t2, large.base.t3, large.base.t4),
  "Tissue Translocation (base Endpoints)" = c(small.base.t1, small.base.t2, small.base.t3, small.base.t4))
