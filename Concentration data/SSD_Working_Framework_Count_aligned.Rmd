...
#Raw Data Export for Evaluation

```{r tables for data review}

a <- tier1_2_large %>% 
  select(doi, article, authors, risk.13, org_f, species_f, lvl1_f, lvl2_f, lvl3_f, bio_f, effect.metric, shape_f, poly_f, size.length.um.used.for.conversions, size.width.um.used.for.conversions, dose.particles.mL.master, dose.particles.mL.master.converted.reported, dose.mg.L.master, dose.mg.L.master.converted.reported) %>% 
  rename("Endpoint_Score" = risk.13, "Particle_Length" = size.length.um.used.for.conversions, "Particle_Width" = size.width.um.used.for.conversions) 
...
list_of_datasets <- list("Tier 1_2, 1-5000um" = a, "Tier 1_2, 1-83um" = b, "Tier 3_4, 1-5000um" = c, "Tier 3_4, 1-83um" = d)
