...
write.xlsx(list_of_datasets, file = "./Concentration data/Threshold_Manuscript_Figs/SSD_rawdata_8312021_lessConservative.xlsx")
...
a.sa.upper = 2.0 #upper surface area power law
a.v.upper = 2.0 #a_V for upper surface water volume
a.m.upper = 2.0 # upper limit fora_m for mass for upper surface water in table S4
...
a.sa.lower = 1.0 #lower surface area power law
a.v.lower = 1.0 #a_V for lower surface water volume
a.m.lower = 1.0 # upper limit fora_m for mass for lower surface water in table S4
...
##--- environmental calculations ---###
  ...
  mutate(mu.sa.mono = case_when(
    polydispersity == "monodisperse" ~ particle.surface.area.um2, # use reported surface area in monodisperse
    polydispersity == "polydisperse" ~  mux.polyfnx1(a.x = a.sa.lower,  #use alpha = 1 eq.
                                  x_LL = particle.surface.area.um2.min,
                                  x_UL = particle.surface.area.um2.max))) %>% 
...
##--- environmental calculations ---###
  ...
  mutate(mu.v.mono = case_when(
    polydispersity == "monodisperse" ~ particle.volume.um3, # use reported volume in monodisperse
    polydispersity == "polydisperse" ~ mux.polyfnx1(a.x = a.v.lower, #use alpha = 1 eq.
                                  x_LL = particle.volume.um3.min,
                                  x_UL = particle.volume.um3.max))) %>% 
...
##--- environmental calculations ---###
  ...
  mutate(mu.m.mono = case_when(
    polydispersity == "monodisperse" ~  mass.per.particle.mg * 1000, # use reported volume in monodisperse
    polydispersity == "polydisperse" ~ mux.polyfnx1(a.x = a.m.lower, #use alpha = 1 eq.
                                  x_UL = mass.per.particle.mg.max * 1000,
                                  x_LL = mass.per.particle.mg.min * 1000))) %>% 
...
##--- environmental calculations ---###
  ...
  mutate(mu.sa.mono = case_when(
    polydispersity == "monodisperse" ~ particle.surface.area.um2, # use reported surface area in monodisperse
    polydispersity == "polydisperse" ~  mux.polyfnx2(a.x = a.sa.upper, #use alpha = 2 eq.
                                  x_LL = particle.surface.area.um2.min,
                                  x_UL = particle.surface.area.um2.max))) %>% 
...
##--- environmental calculations ---###
  ...
  mutate(mu.v.mono = case_when(
    polydispersity == "monodisperse" ~ particle.volume.um3, # use reported volume in monodisperse
    polydispersity == "polydisperse" ~ mux.polyfnx2(a.x = a.v.upper, #use alpha = 2 eq.
                                  x_LL = particle.volume.um3.min,
                                  x_UL = particle.volume.um3.max))) %>% 
...
##--- environmental calculations ---###
  ...
  mutate(mu.m.mono = case_when(
    polydispersity == "monodisperse" ~  mass.per.particle.mg * 1000, # use reported volume in monodisperse
    polydispersity == "polydisperse" ~ mux.polyfnx2(a.x = a.m.upper, #use alpha = 2 eq.
                                  x_UL = mass.per.particle.mg.max * 1000,
                                  x_LL = mass.per.particle.mg.min * 1000))) %>% 
