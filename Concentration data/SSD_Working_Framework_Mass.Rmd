---
title: "SSD Working Framework: µg/L"
...
![](www/treshhold_framework_42121.png)
...
Note: Values may be slightly different than those presented in the shiny app as concentrations are converted from mg/L to µg/L ahead of calculations.
...
tier1_2_large_1q_ggplot <- ggplot(pred_tier1_2_large_1q,aes_string(x = "est")) +
  ...
  labs(title = "Tier 1/2, 1-5000 µm", x = "µg/L") +
...
tier1_2_small_1q_ggplot <- ggplot(pred_tier1_2_small_1q,aes_string(x = "est")) +
      ...
      scale_x_continuous(breaks = scales::trans_breaks("log10", function(x) 10^x, n = 15),
                         labels = trans_format("log10", scales::math_format(10^.x))) + 
  labs(title = "Tier 1/2, 1-10 µm", x = "µg/L") +
      fill.type + #user-selected
      color.type + #user-selected
      theme.type #user theme
...
gt(largesdf) %>% 
  tab_header(title = "Tier 1/2, 1-5000 um", subtitle = "Thresholds presented in ug/L") %>% 
  fmt_number(columns = vars(Tier_1, Tier_2),decimals = 4, use_seps = TRUE) 

gt(smallsdf) %>% 
  tab_header(title = "Tier 1/2, 1-10 um", subtitle = "Thresholds presented in ug/L") %>% 
  fmt_number(columns = vars(Tier_1, Tier_2),decimals = 4, use_seps = TRUE)
...
gt(largesdf) %>% 
  tab_header(title = "Tier 3/4, 1-5000 um", subtitle = "Thresholds presented in ug/L") %>% 
  fmt_number(columns = vars(Tier_3, Tier_4),decimals = 4, use_seps = TRUE) 

gt(smallsdf) %>% 
  tab_header(title = "Tier 3/4, 1-10 um", subtitle = "Thresholds presented in ug/L") %>% 
  fmt_number(columns = vars(Tier_3, Tier_4),decimals = 4, use_seps = TRUE)
