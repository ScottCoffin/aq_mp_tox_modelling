...
gt(largesdf) %>% 
  tab_header(title = "Tier 1/2, 1-5000 um", subtitle = "Thresholds presented in particles/L") %>% 
...
gt(largesdf) %>% 
  tab_header(title = "Tier 3/4, 1-5000 um", subtitle = "Thresholds presented in particles/L") %>% 
