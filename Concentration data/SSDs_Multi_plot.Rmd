...
## 10 - 100 um
#threshold1_all_mgL <- read_csv("Concentration data/SSD_Multi/threshold1_all_mgL_10-100.csv")

#threshold1_tech_mgL <- read_csv("Concentration data/SSD_Multi/threshold1_tech_mgL_10-100.csv")

### 100 - 5000 um
threshold1_all_mgL <- read_csv("Concentration data/SSD_Multi/threshold1_all_mgL_100-5000.csv")
threshold1_tech_mgL <- read_csv("Concentration data/SSD_Multi/threshold1_tech_mgL_100-5000.csv")
```
...
```{r}
#rename 
threshold1_all_mgL <- threshold1_all_mgL %>% 
  dplyr::rename(Conc = `Most Sensitive Concentration mg/L`)

threshold1_tech_mgL <- threshold1_tech_mgL %>% 
  dplyr::rename(Conc = `Most Sensitive Concentration mg/L`)
```
