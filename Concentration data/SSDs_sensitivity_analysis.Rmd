...
rownames(largesdf) <- c("tech.pass.tier 1", "tech.pass.tier 2", "tech.pass.tier 3", "tech.pass.tier 4")
rownames(smallsdf) <- c("tech.pass.tier 1", "tech.pass.tier 2", "tech.pass.tier 3", "tech.pass.tier 4")

# provide tech.pass.tier column
largestibble <- tibble(largesdf,
                       tech.pass.tier = rownames(largesdf))

#re-arrange columns
largestibble <- largestibble[c("tech.pass.tier", "Mean", "Median", "Quartile_1", "Minimum")]

# provide tech.pass.tier column
smallstibble <- tibble(smallsdf,
                       tech.pass.tier = rownames(smallsdf))

#re-arrange columns
smallstibble <- smallstibble[c("tech.pass.tier", "Mean", "Median", "Quartile_1", "Minimum")]
...
data.tables %>% 
  ...
  cols_label(smalls_table = "1-10 um",
             larges_table = "10-5,000 um") %>% 
  tab_source_note(md("Calculated from SSDs")) %>% 
  tab_header(title = "Microplastics HC5 (ug/L) by Data Collapse and tech.pass.tier",
             subtitle = "Smalls and Larges") 
```
