...
#  filter(lvl1_f == "Fitness") %>% 
 ...
 # filter(acute.chronic_f == "Acute") %>% 
  ...
  dplyr::select(c(effect_10, logdose.mg.L.master, logdose.particles.mL.master, logdose.um3.mL.master, logdose.surface.area.um2.mL.master, size.length.um.used.for.conversions)) %>% 
  drop_na()
